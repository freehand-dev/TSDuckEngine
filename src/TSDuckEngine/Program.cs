...
using TSDuckEngine.Infrastructure;
...
IHost host = Host.CreateDefaultBuilder(args)
    ...
    .ConfigureServices((context, services) =>
    {
        ...
        // FFMpegOutputParser
        services.AddSingleton<TSDuckOutputParser>();

        // MetricProcessor
        services.AddSingleton<MetricProcessor>();
        ...
        services.AddOpenTelemetry().WithMetrics(builder =>
        {
            ...
            builder.SetResourceBuilder(
                ResourceBuilder.CreateDefault().AddService(serviceName: Program.ServiceName, serviceInstanceId: Program.InstanceName, serviceVersion: Program.GetVersion()));
            builder.AddMeter(TSDuckEngineMeters.Meter.Name);
...
//
var _ = host.Services.GetRequiredService<MetricProcessor>();
...
partial class Program
{
    ...
    public static readonly string ServiceName = "FreeHand TSDuckEngine";
